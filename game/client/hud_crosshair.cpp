...
void CHudCrosshair::Paint( void )
{
	...
	if( pHL2Player )
	{
		bool bFadeOut = pHL2Player->IsSprinting();

		if( pHL2Player->GetActiveWeapon() )
		{
			bFadeOut |= pHL2Player->m_bHolsteredAW;
		}
		...
		{
			g_pClientMode->GetViewportAnimationController()->RunAnimationCommand( this, "Alpha", 255, 0.0f, 0.5f, vgui::AnimationController::INTERPOLATOR_LINEAR );
		}
	}
#endif
