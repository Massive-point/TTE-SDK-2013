...
#ifdef TACTICALTHOTS
	void					SetRecoilNewOffset(QAngle angOffset) { m_angRecoilOffset = angOffset; }
#endif
...
private:
	...
	float m_flCalculatedViewOffsetRight;
	float m_flCalculatedViewAngleZ;
