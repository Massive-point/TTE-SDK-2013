...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_ATTACH_SILENCER_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DETACH_SILENCER_EMPTY);

	REGISTER_SHARED_ACTIVITY (ACT_VM_IDLE_ADS);
	REGISTER_SHARED_ACTIVITY (ACT_VM_PRIMARYATTACK_ADS);
	REGISTER_SHARED_ACTIVITY (ACT_VM_SECONDARYATTACK_ADS);
	REGISTER_SHARED_ACTIVITY (ACT_VM_PRIMARYATTACK_EMPTY_ADS);
