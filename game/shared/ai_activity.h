...
typedef enum
{
	...
	ACT_VM_ATTACH_SILENCER_EMPTY,
	ACT_VM_DETACH_SILENCER_EMPTY,
	//Activities for ADS (iron sights)
	ACT_VM_IDLE_ADS,
	ACT_VM_PRIMARYATTACK_ADS,
	ACT_VM_SECONDARYATTACK_ADS,
	ACT_VM_PRIMARYATTACK_EMPTY_ADS,
