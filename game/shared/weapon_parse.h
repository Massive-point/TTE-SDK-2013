...
// SHARED
	...
	Vector					vecViewPunchAngles;
	Vector					vecMinViewPunchAngles;
	Vector					vecViewSlide;
	Vector					vecViewSlideIronsighted;

	char					m_szSilencerModel[MAX_WEAPON_STRING];

	float					flNPCBlindDelayMod;

	// tte bullet spread
	float					flHalfRadianBulletSpread;
	float					flHalfRadianBulletSpreadIronsighted;
	float					flBulletSpreadSilencedModifier;

	CWeaponType				m_WeaponType;
#endif
