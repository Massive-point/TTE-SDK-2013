...
#ifdef TACTICALTHOTS
void CAI_BaseNPC::InputFlashBang( inputdata_t &inputdata )
{
	m_flBlindTime = gpGlobals->curtime + inputdata.value.Float();
	
	SetCondition( 74/*COND_COMBINE_HIT_BY_BUGBAIT*/ );
}
#endif
...
#ifdef TACTICALTHOTS
	DEFINE_INPUTFUNC( FIELD_FLOAT,	"flashbang", InputFlashBang ),
#endif
