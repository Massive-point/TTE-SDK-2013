...
void CWeaponFlash::Precache( void )
{
	...
	UTIL_PrecacheOther( "flashbang_projectile" );
...
//	vForward[0] += 0.1f;
	...
	CFlashbangProjectile::Create( vecSrc, vec3_angle, vecThrow, AngularImpulse(600,random->RandomInt(-1200,1200),0), pPlayer, GetWpnData().flNPCBlindDelayMod );
...
void CWeaponFlash::LobGrenade( CBasePlayer *pPlayer )
{
	...
	CFlashbangProjectile::Create( vecSrc, vec3_angle, vecThrow, AngularImpulse(200,random->RandomInt(-600,600),0), pPlayer, GetWpnData().flNPCBlindDelayMod );
...
void CWeaponFlash::RollGrenade( CBasePlayer *pPlayer )
{
	...
	CFlashbangProjectile::Create( vecSrc, orientation, vecThrow, rotSpeed, pPlayer, GetWpnData().flNPCBlindDelayMod );
