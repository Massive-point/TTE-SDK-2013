...
DEFINE_FIELD(m_iIdleBlinknum, FIELD_INTEGER),
DEFINE_FIELD(m_iRandomHead, FIELD_INTEGER),
...
void CHL1NPCTalker::Precache()
{
	...
	PrecacheModel("models/gibs/humans/eye_gib.mdl");
	PrecacheModel("models/gibs/humans/brain_gib.mdl");
	PrecacheModel("models/gibs/humans/heart_gib.mdl");
	PrecacheModel("models/gibs/humans/lung_gib.mdl");
	PrecacheModel("models/gibs/humans/liver_gib.mdl");
	...
	PrecacheModel("models/gibs/humans/guard/torso.mdl");
	PrecacheModel("models/gibs/humans/guard/left_arm.mdl");
	PrecacheModel("models/gibs/humans/guard/right_leg.mdl");
	PrecacheModel("models/gibs/humans/guard/right_arm.mdl");
	//Sci Gibs
	PrecacheModel("models/gibs/humans/scientists/torso.mdl");
	PrecacheModel("models/gibs/humans/scientists/left_arm.mdl");
	PrecacheModel("models/gibs/humans/scientists/left_leg.mdl");
	PrecacheModel("models/gibs/humans/scientists/right_leg.mdl");
	PrecacheModel("models/gibs/humans/scientists/right_arm.mdl");

	PrecacheScriptSound("NPC.StepLeftWalk");
	PrecacheScriptSound("NPC.StepRightWalk");

	PrecacheParticleSystem("gib_human_spurt");
	PrecacheScriptSound("Barney.Close");
	PrecacheScriptSound("TF2.CorpseGib");
}
...
bool CHL1NPCTalker::CorpseGib(const CTakeDamageInfo &info)
{
	...
	static int s_nBodyBone2 = -1;
	if (s_nBodyBone == -1)
	{
		s_nBodyBone = LookupBone("ValveBiped.Bip01_Pelvis");
		s_nBodyBone2 = LookupBone("ValveBiped.Bip01_Spine2");
	}
	EmitSound("TF2.CorpseGib");
	Vector vecOrigin, vecOrigin2;
	QAngle angBone;
	GetBonePosition(s_nBodyBone, vecOrigin, angBone);

	DispatchParticleEffect("gib_human_spurt", vecOrigin, QAngle(0, 0, 0));

	GetBonePosition(s_nBodyBone2, vecOrigin2, angBone);

	DispatchParticleEffect("gib_human_spurt", vecOrigin2, QAngle(180, 0, 0));
	...
	breakablepropparams_t params(EyePosition(), GetAbsAngles(), vecGibVelocity, vecGibAVelocity);
