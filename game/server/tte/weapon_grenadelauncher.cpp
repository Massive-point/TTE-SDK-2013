...
ConVar tte_sticky_grenade_dmg( "tte_sticky_grenade_dmg", "175" );
ConVar tte_normal_grenade_dmg( "tte_normal_grenade_dmg", "100" );
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponGrenadeLauncher::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
void CWeaponGrenadeLauncher::PrimaryAttack( void )
{
	...
	pGrenade->SetDamage( tte_normal_grenade_dmg.GetFloat() );
...
void CWeaponGrenadeLauncher::SecondaryAttack( void )
{
	...
	CGrenadeSticky *pGrenade = (CGrenadeSticky*)Create( "grenade_sticky", vecSrc, angles, pPlayer );

	pGrenade->SetThrower( GetOwner() );
	pGrenade->SetDamage( tte_sticky_grenade_dmg.GetFloat() );
	...
	if( pGrenade->VPhysicsGetObject() )
	{
		...
		pGrenade->VPhysicsGetObject()->AddVelocity( &vecThrow, &angImp );
	}
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponGrenadeLauncher::WeaponRangeAttack2Condition( float flDot, float flDist )
{
