...
public:
	...
	NPC_STATE			m_IdealNPCState;		// npc should change to this state, put here because of conscripts
...
public:
	...
	{
		if (m_flBlindTime > gpGlobals->curtime)
		{
			return NULL;
		}
...
#ifdef TACTICALTHOTS
	void				InputFlashBang(inputdata_t &inputdata);
