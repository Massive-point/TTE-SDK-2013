...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_ATTACH_SILENCER_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_DETACH_SILENCER_EMPTY);

	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_ADS);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_ADS);
	ADD_ACTIVITY_TO_SR(ACT_VM_SECONDARYATTACK_ADS);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_EMPTY_ADS);
