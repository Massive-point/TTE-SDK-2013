...
bool CWeaponSMG1::Reload( void )
{
	...
	if (fRet)
	{
		//TACTICALTHOTS
		//
		// |This makes the reload animation(and the whole reload) finish too early when the sprint button is pressed and then released.
		// |Probably it has something to do with lowering weapon on sprint.
		// |				Disabled for now.
		// V
