...
//	>> BoxSRounds
// ========================================================================
class CItem_FlamethrowerFuel : public CItem
{
public:
	DECLARE_CLASS( CItem_FlamethrowerFuel, CItem );
	...
	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo( pPlayer, 50, "Uranium"))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
LINK_ENTITY_TO_CLASS(item_ammo_flamethrower, CItem_FlamethrowerFuel);
#endif
